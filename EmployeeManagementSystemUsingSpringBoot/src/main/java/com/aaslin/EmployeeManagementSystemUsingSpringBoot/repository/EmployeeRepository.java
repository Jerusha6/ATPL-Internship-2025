...
public interface EmployeeRepository extends JpaRepository<Employee,Integer>{
	...
	public void updatePassword(@Param("employeeId") String employeeId, @Param("password") String password);

	@Modifying
	@Transactional
	@Query("UPDATE Employee e SET e.isDeleted = true WHERE e.employeeId = :employeeId")
	public void terminateEmployee(@Param("employeeId")String employeeId);
	
	@Query("SELECT e FROM Employee e WHERE e.isDeleted = false and e.employeeId=:employeeId")
